          ...
          <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800">
            ...
            <div className="p-6 flex flex-col gap-6">
              ...
              <label className="flex flex-col">
                ...
                <div className="flex items-center rounded-lg border border-slate-300 dark:border-slate-700 focus-within:ring-2 focus-within:ring-primary/50 bg-white dark:bg-slate-800/50">
                  <span className="px-3 text-sm text-slate-400 dark:text-slate-500">
                    /blog/
                  </span>
                  <input
                    className="form-input w-full text-[#111318] dark:text-white border-none bg-transparent h-11 px-0 text-sm"
