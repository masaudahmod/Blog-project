...
export default async function Latest() {
  ...
  const sectionTitle = latestContent?.content?.title || "Latest News";
  ...
  const adTitle = adContent?.content?.title || "AI World Summit 2024";
  const adDescription = adContent?.content?.description || "Join 5,000+ researchers in San Francisco this October.";
  const adCtaLabel = adContent?.content?.subtitle || "Get Tickets";
  const adLink = adContent?.content?.link || "#";
  
  // Second Ad - Visiting/Affiliate
  const ad2Title = ad2Content?.content?.title || "Explore Our Partners";
  const ad2Description = ad2Content?.content?.description || "Discover amazing products and services from our trusted affiliates.";
  const ad2CtaLabel = ad2Content?.content?.subtitle || "Visit Now";
    ...
    <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-6">
          ...
          <div className="relative bg-gradient-to-br from-emerald-900 to-teal-900 dark:from-emerald-950 dark:to-teal-950 rounded-xl p-6 border-2 border-white/20 dark:border-white/10 overflow-hidden">
            {/* Advertisement Label */}
            <div className="absolute top-3 left-3">
              <span className="text-xs font-semibold text-white/70 dark:text-white/60 uppercase tracking-wide">
                Advertisement
          ...
          <div className="relative bg-gradient-to-br from-purple-900 to-pink-900 dark:from-purple-950 dark:to-pink-950 rounded-xl p-6 border-2 border-white/20 dark:border-white/10 overflow-hidden">
            {/* Advertisement Label */}
            <div className="absolute top-3 left-3">
              <span className="text-xs font-semibold text-white/70 dark:text-white/60 uppercase tracking-wide">
                Advertisement
