...
interface LatestProps { // Define Latest component props
  articles?: Article[]; // Optional articles list
  trendingArticles?: TrendingArticle[]; // Optional trending list
  sectionTitle?: string; // Optional section title
  sectionCtaLabel?: string; // Optional section CTA label
  digestTitle?: string; // Optional digest title
  digestDescription?: string; // Optional digest description
  trendingTitle?: string; // Optional trending title
  adTitle?: string; // Optional ad title
  adDescription?: string; // Optional ad description
  adCtaLabel?: string; // Optional ad CTA label
} // End LatestProps
...
export default function Latest({
  ...
  sectionTitle = "Latest News", // Provide default section title
  sectionCtaLabel = "View all", // Provide default CTA label
  digestTitle = "AI Daily Digest", // Provide default digest title
  digestDescription = "Key takeaways generated by our model from 50+ sources today.", // Provide default digest description
  trendingTitle = "Trending Now", // Provide default trending title
  adTitle = "AI World Summit 2024", // Provide default ad title
  adDescription = "Join 5,000+ researchers in San Francisco this October.", // Provide default ad description
  adCtaLabel = "Get Tickets", // Provide default ad CTA label
}: LatestProps) { // Start Latest component
  return (
